...
import 'package:cafe_and_resto/screens/homepage/product/product_edit_screen.dart';
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Row(
            children: [
              Text('Konfirmasi Menghapus', style: TextStyle(fontSize: 18,),),
              Icon(
                Icons.delete,
