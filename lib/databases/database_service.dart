...
class DatabaseService {
  ...
  static void setProduct(
      String name, String description, String category, int price, int quantity, String image) {
    try {
  ...
  static void updateProduct(String name, String description, String category, int price,
  ...
  static updateCart(String cartId, int qty, int price) {
    try {
      ...
      toast('Sukses mengurangi kuantitas produk ini kedalam keranjang');
    } catch (error) {
      toast('Gagal mengurangi kuantitas produk ini kedalam keranjang');
    }
  }
  ...
  static updateQuantityProduct(String productId, int newQty) {
    try {
      ...
      toast('Sukses menambahkan kuantitas produk ini');
    } catch (error) {
      toast('Gagal menambahkan kuantitas produk ini');
    }
  }
}